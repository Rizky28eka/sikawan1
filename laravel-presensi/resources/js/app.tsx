...
createInertiaApp({
    ...
    setup({ el, App, props }) {
        ...
        console.group(
            "%c 🚀 SIKAWAN - Enterprise Attendance System ",
        ...
        router.on("start", (event) => {
            console.log(
                `%c 🛫 [Inertia Request] -> ${event.detail.visit.url} [${event.detail.visit.method}]`,
        ...
        router.on("success", (event) => {
            console.log(
                `%c ✅ [Inertia Success] -> ${event.detail.page.component}`,
